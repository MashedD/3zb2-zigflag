	...
	//roamnavi やめた
		...
		for (i = 0; i < 10; i++) {
			...
			if (!Route[other->client->zc.routeindex + i].index)
				break;
			if (Route[other->client->zc.routeindex + i].state == GRS_PUSHBUTTON && Route[other->client->zc.routeindex + i].ent == ent->union_ent) {
...
void Touch_Item (edict_t *ent, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	if (!k && chedit->value && CurrentIndex < MAXNODES && other == &g_edicts[1]) {
		if ((ent->classname[0] == 'w' || (ent->classname[0] == 'i' && (ent->classname[5] == 'q' || ent->classname[5] == 't' || ent->classname[5] == 'f' || ent->classname[5] == 'i' || ent->classname[5] == 'p' || ent->classname[5] == 's' || ent->classname[5] == 'b' || ent->classname[5] == 'e' || ent->classname[5] == 'a')) || (ent->classname[0] == 'i' && ent->classname[5] == 'h' && ent->classname[12] == 'm') || (ent->classname[0] == 'a')) && !(ent->spawnflags & (DROPPED_ITEM | DROPPED_PLAYER_ITEM))) {
...
*/

	{
	  ...
	  Weapon_Ionripper,
	  "misc/w_pkup.wav",
	  "models/weapons/g_boom/tris.md2",
	  EF_ROTATE,
...
*/

	{
	  ...
	  Weapon_Phalanx,
	  "misc/w_pkup.wav",
	  "models/weapons/g_shotx/tris.md2",
	  EF_ROTATE,
